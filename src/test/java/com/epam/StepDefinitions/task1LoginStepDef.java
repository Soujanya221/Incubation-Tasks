...
import com.epam.Pages.SeleTask1LoginPage;
import com.epam.ui.Log;
...
public class task1LoginStepDef {
    WebDriver driver;
    SeleTask1LoginPage loginPage;
    WebDriverWait wait;
    @Given("I am on the login page")
    public void i_am_on_the_login_page() {
        driver = new EdgeDriver();
        driver.get("https://the-internet.herokuapp.com/login");
        loginPage = new SeleTask1LoginPage(driver);
    }
